...
export type ModuleKey = 
  ...
  | 'settings' | 'reports' | 'warehouses' | 'users' | 'sales_history' | 'receipt_preview' | 'finance';
...
export const MODULE_REGISTRY: Record<ModuleKey, ModuleDef> = {
  ...
  finance:    { title: 'Finance',                icon: '💰', defaultWidth: 900,  defaultHeight: 600, minWidth: 500, minHeight: 400 },
