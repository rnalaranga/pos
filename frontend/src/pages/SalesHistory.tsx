...
const SalesHistory = () => {
  ...
  const handlePreviewReceipt = (saleId: number) => {
    // Open the receipt preview in the internal MDI window manager
    openWindow('receipt_preview', { saleId, title: `Receipt ${saleId}` });
  };
