  ...
  return (
    <div className="flex flex-col h-full bg-background text-foreground printable-sales-history">
      ...
      <div className="bg-white p-5 rounded-2xl border border-border shadow-sm shrink-0 no-print">
        ...
        <form onSubmit={handleFilterSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-3">
      ...
      {previewData && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl border border-border animate-in fade-in zoom-in-95 duration-200 overflow-hidden flex flex-col max-h-[95vh] w-full max-w-lg">
            ...
            <div className="overflow-auto p-2 md:p-6 flex justify-center items-start custom-scrollbar bg-slate-100 w-full">
